<aside id="left-sidebar-nav">
    ...
    <li class="user-details cyan darken-2">
        ...
        <div class="col col s8 m8 l8">
            ...
            <a class="btn-flat dropdown-button waves-effect waves-light white-text profile-btn" href="#" data-activates="profile-dropdown-nav">Seminario<i class="mdi-navigation-arrow-drop-down right"></i></a>
